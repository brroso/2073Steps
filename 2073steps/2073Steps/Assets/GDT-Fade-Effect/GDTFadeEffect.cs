...
public class GDTFadeEffect : MonoBehaviour
{
    ...
    private Color lastColorFantasma = new Color(0f, 0f, 0.22f, 0.3f);
    private Color auxLastColor;
    ...
    void FixedUpdate()
    {
        if (performEffect)
        {
            ...
            if (GameManager.current_character == Character.Fantasma)
                lastColor = lastColorFantasma;
            else
                lastColor = auxLastColor;
